            ...
            <section className="service-details">
                <div className="container">
                            ...
                            <div className="col-xl-4 col-lg-8 order-2">
                                <div className="service-details__sidebar">
                                    ...
                                    <ul className="service-details__sidebar-list">
                                        ...
                                        <li className="service-details__sidebar-list-item"><Link href="/" className="active">Car Cleaning</Link></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="service-details__bottom">
                        <h2 className="service-details__bottom-title">Professional Car Cleaning Services</h2>
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-8 col-lg-7">
                                    <div className="content-box">
                                        ...
                                        <ul>
                                            <li><span className="icon-plus"></span> Steam seat extraction + Italian leather conditioning.</li>
                                            <li><span className="icon-plus"></span> Headlight restoration + industrial fallout decontamination.</li>
                                            <li><span className="icon-plus"></span> Nano-ceramic coating + 24-month hydrophobic warranty.</li>
                                            <li><span className="icon-plus"></span> Vintage convertible top restoration + wire wheel detailing.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
